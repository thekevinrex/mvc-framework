...
class HybiFrame extends Frame
{
    ...
    protected function getMask()
    {
        if (!isset($this->mask)) {
            ...
            return $this->mask = substr($this->buffer, $this->getMaskOffset(), $this->getMaskSize());
        }
        return $this->mask;
    }
    ...
    public function isMasked()
    {
        if (!isset($this->masked)) {
            ...
            return $this->masked = (boolean) (ord($this->buffer[1]) & self::BITFIELD_MASKED);
        }
        return $this->masked;
    }
    ...
    protected function getMaskOffset()
    {
        if (!isset($this->offset_mask)) {
            ...
            return $this->offset_mask = $offset;
        }
    ...
    protected function getPayloadOffset()
    {
        if (!isset($this->offset_payload)) {
            ...
            return $this->offset_payload = $offset;
        }
